...
// moved to top (from component) - mention this while recording
const initialValues = {
  email: "",
  password: "",
  rememberme: false,
...
function LoginPage() {
  ...
  const handleSubmit =async (values, { setSubmitting }) => {
    setSubmitting(true);
    try{
       const response = await loginAPI({email:values.email, password:values.password}).unwrap();
    ...
    //   // Simulating API call or authentication process
    //   console.log(values);
    //   dispatch(login({ user: "nivi", _id: "123"  }));
    //   navigate("/home");
    //   resetForm();
